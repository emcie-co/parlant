...
class GenericObservationalSchema(DefaultBaseModel):
    guideline_id: str
    condition: str
    rationale: str
    applies: bool
...
class GenericObservationalGuidelineMatchesSchema(DefaultBaseModel):
    checks: Sequence[GenericObservationalSchema]
...
class GenericObservationalGuidelineMatchingBatch(GuidelineMatchingBatch):
    ...
    def _match_applies(self, match: GenericObservationalSchema) -> bool:
