...
# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_previously_matched_guideline_are_not_matched_when_there_is_no_new_reason
async def test_that_previously_matched_guideline_are_not_matched_when_there_is_no_new_reason(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        conversation_guideline_names=["problem_so_restart"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["problem_so_restart"],
    )
...
async def test_that_partially_fulfilled_action_with_missing_behavioral_part_is_not_matched_again(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["calm_and_reset_password"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["calm_and_reset_password"],
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_guideline_that_was_reapplied_earlier_and_should_not_reapply_based_on_the_most_recent_interaction_is_not_matched_1
async def test_that_guideline_that_was_reapplied_earlier_and_should_not_reapply_based_on_the_most_recent_interaction_is_not_matched_1(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["frustrated_so_discount"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["frustrated_so_discount"],
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_guideline_that_was_reapplied_earlier_and_should_not_reapply_based_on_the_most_recent_interaction_is_not_matched_2
async def test_that_guideline_that_was_reapplied_earlier_and_should_not_reapply_based_on_the_most_recent_interaction_is_not_matched_2(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["order_status"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["order_status"],
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_guideline_that_was_reapplied_earlier_and_should_reapply_again_based_on_the_most_recent_interaction_is_matched
async def test_that_guideline_that_was_reapplied_earlier_and_should_reapply_again_based_on_the_most_recent_interaction_is_matched(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["confirm_reservation"],
        relevant_guideline_names=["confirm_reservation"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_guideline_that_should_reapply_is_matched_when_condition_holds_in_the_last_several_messages
...
# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_reapplied_guideline_is_still_applied_when_handling_conditions_sub_issue
...
# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_guideline_is_still_matched_when_conversation_still_on_sub_topic_that_made_condition_hold
...
# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_previously_applied_guidelines_are_matched_based_on_capabilities
...
# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_previously_applied_guidelines_are_matched_based_on_capabilities_emotional_reasoning
...
# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_previously_applied_guidelines_are_matched_based_on_capabilities_with_context_change
...
# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_batch.py::test_that_previously_applied_guidelines_are_not_matched_based_on_irrelevant_capabilities
