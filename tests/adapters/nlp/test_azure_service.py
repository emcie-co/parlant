...
def test_that_failed_azure_ad_authentication_returns_error_message(mock_credential_class: Mock) -> None:
...
@patch('parlant.adapters.nlp.azure_service.DefaultAzureCredential')
@patch('parlant.adapters.nlp.azure_service.AsyncAzureOpenAI')
def test_that_client_creation_with_azure_ad_works(mock_openai_class: Mock, mock_credential_class: Mock) -> None:
...
@patch('parlant.adapters.nlp.azure_service.DefaultAzureCredential')
def test_that_client_creation_fails_with_azure_ad_authentication_error(mock_credential_class: Mock) -> None:
...
def test_that_custom_azure_schematic_generator_initializes_correctly(mock_create_client: Mock) -> None:
...
@patch('parlant.adapters.nlp.azure_service.create_azure_client')
def test_that_azure_service_returns_custom_schematic_generator_when_configured(mock_create_client: Mock) -> None:
...
@patch('parlant.adapters.nlp.azure_service.create_azure_client')
def test_that_azure_service_returns_default_schematic_generator_when_not_configured(mock_create_client: Mock) -> None:
...
@patch('parlant.adapters.nlp.azure_service.create_azure_client')
def test_that_azure_service_returns_custom_embedder_when_configured(mock_create_client: Mock) -> None:
...
@patch('parlant.adapters.nlp.azure_service.create_azure_client')
def test_that_azure_service_returns_default_embedder_when_not_configured(mock_create_client: Mock) -> None:
...
@patch('parlant.adapters.nlp.azure_service.DefaultAzureCredential')
def test_that_create_azure_client_creates_client_with_token_provider(mock_credential_class: Mock) -> None:
