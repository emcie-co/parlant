...
# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_a_rule_whose_condition_is_partially_satisfied_not_matched
async def test_that_a_rule_whose_condition_is_partially_satisfied_not_matched(
    ranker: RuleRanker,
) -> None:
    ...
    await base_test_that_rules_are_ranked_correctly(
        ...
        conversation_rule_names=["first_order_and_order_more_than_2"],
        relevant_rule_names=[],
        irrelevant_rule_names=["first_order_and_order_more_than_2"],
    )


# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_rule_whose_condition_was_partially_fulfilled_now_matches
async def test_that_rule_whose_condition_was_partially_fulfilled_now_matches(
    ranker: RuleRanker,
) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
    ...
    await base_test_that_rules_are_ranked_correctly(
        ...
        conversation=conversation,
        conversation_rule_names=["first_order_and_order_more_than_2"],
        relevant_rule_names=["first_order_and_order_more_than_2"],
        irrelevant_rule_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_rule_whose_condition_was_initially_not_fulfilled_now_matches
async def test_that_rule_whose_condition_was_initially_not_fulfilled_now_matches(
    ranker: RuleRanker,
) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
    ...
    await base_test_that_rules_are_ranked_correctly(
        ...
        RULES_DICT,
        conversation=conversation,
        conversation_rule_names=["first_order_and_order_exactly_2"],
        relevant_rule_names=["first_order_and_order_exactly_2"],
        irrelevant_rule_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_rule_whose_condition_was_initially_not_fulfilled_now_matches_with_subtopic
async def test_that_rule_whose_condition_was_initially_not_fulfilled_now_matches_with_subtopic(
    ranker: RuleRanker,
) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
...
# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_rule_whose_condition_was_initially_not_fulfilled_now_matches_after_long_conversation
async def test_that_rule_whose_condition_was_initially_not_fulfilled_now_matches_after_long_conversation(
    ranker: RuleRanker,
) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
...
# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_conflicting_actions_with_similar_conditions_are_both_matched
async def test_that_conflicting_actions_with_similar_conditions_are_both_matched(
    ...
    await base_test_that_rules_are_ranked_correctly(
        ...
        RULES_DICT,
        conversation=conversation,
        conversation_rule_names=["transfer_to_manager", "don't_transfer_to_manager"],
        relevant_rule_names=["transfer_to_manager", "don't_transfer_to_manager"],
        irrelevant_rule_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_rule_with_already_applied_condition_but_unaddressed_action_is_not_matched_when_conversation_was_drifted
async def test_that_rule_with_already_applied_condition_but_unaddressed_action_is_not_matched_when_conversation_was_drifted(
    ranker: RuleRanker,
) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
    ...
    await base_test_that_rules_are_ranked_correctly(
        ...
        RULES_DICT,
        conversation=conversation,
        conversation_rule_names=["cancel_subscription"],
        relevant_rule_names=[],
        irrelevant_rule_names=["cancel_subscription"],
    )


# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_rule_with_already_applied_condition_but_unaddressed_action_is_not_matched_when_conversation_was_drifted_2
async def test_that_rule_with_already_applied_condition_but_unaddressed_action_is_not_matched_when_conversation_was_drifted_2(
    ranker: RuleRanker,
) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
    ...
    await base_test_that_rules_are_ranked_correctly(
        ...
        RULES_DICT,
        conversation=conversation,
        conversation_rule_names=["identify_problem"],
        relevant_rule_names=[],
        irrelevant_rule_names=["identify_problem"],
    )


# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_rule_with_already_matched_condition_but_unaddressed_action_is_matched
async def test_that_rule_with_already_matched_condition_but_unaddressed_action_is_matched(
    ranker: RuleRanker,
) -> None:
    conversation: list[tuple[EventSource, str]] = [
...
# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_rule_is_still_matched_when_conversation_still_on_the_same_topic_that_made_condition_hold
async def test_that_rule_is_still_matched_when_conversation_still_on_the_same_topic_that_made_condition_hold(
    ranker: RuleRanker,
) -> None:
    conversation: list[tuple[EventSource, str]] = [
    ...
    await base_test_that_rules_are_ranked_correctly(
        ...
        RULES_DICT,
        conversation=conversation,
        conversation_rule_names=["do_payment"],
        relevant_rule_names=["do_payment"],
        irrelevant_rule_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_rule_is_still_matched_when_conversation_still_on_sub_topic_that_made_condition_hold
...
# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_rule_is_still_matched_when_conversation_still_on_sub_topic_that_made_condition_hold_2
async def test_that_rule_is_still_matched_when_conversation_still_on_sub_topic_that_made_condition_hold_2(
    ranker: RuleRanker,
) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
    ...
    await base_test_that_rules_are_ranked_correctly(
        ...
        RULES_DICT,
        conversation=conversation,
        conversation_rule_names=["ordering_sandwich"],
        relevant_rule_names=["ordering_sandwich"],
        irrelevant_rule_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_previously_applied_rules_are_matched_based_on_capabilities
...
# Taken from tests/core/stable/engines/alpha/test_rule_actionable_batch.py::test_that_previously_applied_rules_are_not_matched_based_on_irrelevant_capabilities
async def test_that_previously_applied_rules_are_not_matched_based_on_irrelevant_capabilities(
    ...
    await base_test_that_rules_are_ranked_correctly(
        ...
        relevant_rule_names=[],
        irrelevant_rule_names=["unsupported_capability", "multiple_capabilities"],
        capabilities=capabilities,
    )
