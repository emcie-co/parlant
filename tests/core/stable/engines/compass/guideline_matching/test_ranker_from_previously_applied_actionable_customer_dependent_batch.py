...
# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_customer_dependent_batch.py::test_that_customer_dependent_guideline_is_matched_when_customer_hasnt_completed_their_side
async def test_that_customer_dependent_guideline_is_matched_when_customer_hasnt_completed_their_side(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        conversation_guideline_names=["reservation_location"],
        relevant_guideline_names=["reservation_location"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_customer_dependent_batch.py::test_that_customer_dependent_guideline_is_not_matched_when_customer_has_completed_their_side
async def test_that_customer_dependent_guideline_is_not_matched_when_customer_has_completed_their_side(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        irrelevant_guideline_names=["reservation_location"],
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_customer_dependent_batch.py::test_that_customer_dependent_guideline_is_matched_when_customer_hasnt_completed_their_side_over_several_messages
...
# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_customer_dependent_batch.py::test_that_customer_dependent_guideline_is_not_matched_when_customer_hasnt_completed_their_side_but_change_subject
async def test_that_customer_dependent_guideline_is_not_matched_when_customer_hasnt_completed_their_side_but_change_subject(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["issue_reporting"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["issue_reporting"],
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_customer_dependent_batch.py::test_that_customer_dependent_guideline_is_matched_when_customer_hasnt_completed_their_side_on_the_second_time
async def test_that_customer_dependent_guideline_is_matched_when_customer_hasnt_completed_their_side_on_the_second_time(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["order_lookup"],
        relevant_guideline_names=["order_lookup"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_customer_dependent_batch.py::test_that_customer_dependent_guideline_is_matched_when_condition_arises_for_the_second_time
...
# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_customer_dependent_batch.py::test_that_customer_dependent_guideline_is_not_matched_when_condition_arises_for_the_second_time_but_completed
async def test_that_customer_dependent_guideline_is_not_matched_when_condition_arises_for_the_second_time_but_completed(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        conversation_guideline_names=["order_lookup"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["order_lookup"],
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_customer_dependent_batch.py::test_that_customer_dependent_guideline_is_not_matched_when_condition_arises_for_the_second_time_but_dont_need_to_take_the_action_again
async def test_that_customer_dependent_guideline_is_not_matched_when_condition_arises_for_the_second_time_but_dont_need_to_take_the_action_again(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["order_alcohol"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["order_alcohol"],
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_customer_dependent_batch.py::test_that_customer_dependent_guideline_is_matched_based_on_capabilities_1
async def test_that_customer_dependent_guideline_is_matched_based_on_capabilities_1(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        irrelevant_guideline_names=["multiple_capabilities"],
        capabilities=capabilities,
    )


# Taken from tests/core/stable/engines/alpha/test_previously_applied_actionable_customer_dependent_batch.py::test_that_customer_dependent_guideline_is_matched_based_on_capabilities_2
async def test_that_customer_dependent_guideline_is_matched_based_on_capabilities_2(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        conversation=conversation,
        conversation_guideline_names=["unsupported_capability", "multiple_capabilities"],
        relevant_guideline_names=["multiple_capabilities"],
