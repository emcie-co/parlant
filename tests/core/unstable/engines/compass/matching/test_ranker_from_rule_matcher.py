...
# Taken from tests/core/unstable/engines/alpha/test_rule_matcher.py::test_that_observational_rules_are_detected_correctly_when_lots_of_data_is_available
async def test_that_observational_rules_are_detected_correctly_when_lots_of_data_is_available(
    ranker: RuleRanker,
) -> None:
