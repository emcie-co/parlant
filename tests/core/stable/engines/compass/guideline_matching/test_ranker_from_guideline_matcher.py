...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_relevant_guidelines_are_matched_parametrized_2
async def test_that_relevant_guidelines_are_matched_parametrized_2(ranker: GuidelineRanker) -> None:
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        irrelevant_guideline_names=["class_booking", "address_location"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_irrelevant_guidelines_are_not_matched_parametrized_1
async def test_that_irrelevant_guidelines_are_not_matched_parametrized_1(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["check_toppings_in_stock", "check_drinks_in_stock"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["check_toppings_in_stock", "check_drinks_in_stock"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guidelines_are_matched_based_on_agent_description
async def test_that_guidelines_are_matched_based_on_agent_description(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["cant_perform_request"],
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guidelines_are_matched_based_on_glossary
async def test_that_guidelines_are_matched_based_on_glossary(ranker: GuidelineRanker) -> None:
    terms = [
        create_term(
            name="skateboard",
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["tree_allergies"],
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_conflicting_actions_with_similar_conditions_are_both_detected
async def test_that_conflicting_actions_with_similar_conditions_are_both_detected(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["credit_payment1", "credit_payment2"],
        relevant_guideline_names=["credit_payment1", "credit_payment2"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guidelines_are_matched_based_on_staged_tool_calls_and_context_variables
async def test_that_guidelines_are_matched_based_on_staged_tool_calls_and_context_variables(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["suggest_drink_underage", "suggest_drink_adult"],
        relevant_guideline_names=["suggest_drink_underage"],
        irrelevant_guideline_names=["suggest_drink_adult"],
        context_variables=context_variables,
        staged_events=staged_events,
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guidelines_are_matched_based_on_staged_tool_calls_without_context_variables
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_already_addressed_guidelines_are_not_matched
async def test_that_already_addressed_guidelines_are_not_matched(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["cheese_pizza"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["cheese_pizza"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guidelines_referring_to_continuous_processes_are_detected_even_if_already_fulfilled
async def test_that_guidelines_referring_to_continuous_processes_are_detected_even_if_already_fulfilled(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["cheese_pizza_process"],
        relevant_guideline_names=["cheese_pizza_process"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_already_addressed_condition_but_unaddressed_action_is_matched
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_is_not_detected_based_on_its_action
async def test_that_guideline_is_not_detected_based_on_its_action(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["announce_deals"],
        relevant_guideline_names=["announce_deals"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_fulfilled_action_regardless_of_condition_can_be_reapplied
async def test_that_guideline_with_fulfilled_action_regardless_of_condition_can_be_reapplied(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["add_to_count"],
        relevant_guideline_names=["add_to_count"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_initial_response_is_matched
async def test_that_guideline_with_initial_response_is_matched(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
            "Hello!",
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["cow_response"],
        relevant_guideline_names=["cow_response"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_multiple_actions_is_partially_fulfilled_when_a_few_actions_occurred
async def test_that_guideline_with_multiple_actions_is_partially_fulfilled_when_a_few_actions_occurred(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["many_actions"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["many_actions"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_detected_1
async def test_that_observational_guidelines_are_detected_1(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["vegetarian_customer"],
        relevant_guideline_names=["vegetarian_customer"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_irrelevant_observational_guidelines_are_not_detected_1
async def test_that_irrelevant_observational_guidelines_are_not_detected_1(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        conversation_guideline_names=["vegetarian_customer"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["vegetarian_customer"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_detected_2
async def test_that_observational_guidelines_are_detected_2(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["frustrated_customer_observational"],
        relevant_guideline_names=["frustrated_customer_observational"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_irrelevant_observational_guidelines_are_not_detected_2
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_detected_3
async def test_that_observational_guidelines_are_detected_3(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        irrelevant_guideline_names=["delivery_order"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_detected_5
async def test_that_observational_guidelines_are_detected_5(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_detected_4
async def test_that_observational_guidelines_are_detected_4(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_detected_based_on_context_variables
async def test_that_observational_guidelines_are_detected_based_on_context_variables(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["season_is_winter"],
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_detected_based_on_tool_results
async def test_that_observational_guidelines_are_detected_based_on_tool_results(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        relevant_guideline_names=["season_is_winter"],
        irrelevant_guideline_names=["ever_requested_lock_card", "lost_card"],
        staged_events=staged_events,
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_matched_based_on_glossary
async def test_that_observational_guidelines_are_matched_based_on_glossary(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        irrelevant_guideline_names=["unknown_service", "unanswered_questions"],
        terms=terms,
        capabilities=capabilities,
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_matched_based_on_vague_customer_message
async def test_that_observational_guidelines_are_matched_based_on_vague_customer_message(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["credit_limits_discussion"],
        relevant_guideline_names=["credit_limits_discussion"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_matched_based_on_old_messages
async def test_that_observational_guidelines_are_matched_based_on_old_messages(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["ever_requested_lock_card", "lost_card"],
        relevant_guideline_names=["ever_requested_lock_card"],
        irrelevant_guideline_names=["lost_card"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_not_matched_based_when_topic_was_shifted
async def test_that_observational_guidelines_are_not_matched_based_when_topic_was_shifted(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["reset_password", "credit_limits_discussion"],
        relevant_guideline_names=["credit_limits_discussion"],
        irrelevant_guideline_names=["reset_password"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_matched_when_conversation_is_on_sub_topic
async def test_that_observational_guidelines_are_matched_when_conversation_is_on_sub_topic(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["book_flight", "book_flight_2"],
        relevant_guideline_names=["book_flight", "book_flight_2"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_both_observational_and_actionable_guidelines_are_matched_together
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_irrelevant_guidelines_are_not_matched_parametrized_2
async def test_that_irrelevant_guidelines_are_not_matched_parametrized_2(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["check_drinks_in_stock"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["check_drinks_in_stock"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_is_matched
async def test_that_guideline_with_agent_intention_is_matched(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["medical_record"],
        relevant_guideline_names=["medical_record"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_is_matched_2
async def test_that_guideline_with_agent_intention_is_matched_2(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        irrelevant_guideline_names=["confirm_order", "discuss_money"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_is_matched_3
async def test_that_guideline_with_agent_intention_is_matched_3(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["confirm_order"],
        relevant_guideline_names=["confirm_order"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_is_matched_4
async def test_that_guideline_with_agent_intention_is_matched_4(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["discuss_money"],
        relevant_guideline_names=["discuss_money"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_is_matched_5
async def test_that_guideline_with_agent_intention_is_matched_5(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["human_resources"],
        relevant_guideline_names=["human_resources"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_is_not_matched
async def test_that_guideline_with_agent_intention_is_not_matched(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
            "Hey do you sell iPhone 15?",
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        conversation_guideline_names=["confirm_order"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["confirm_order"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_is_not_matched_2
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_and_customer_dependent_action_that_was_previously_applied_is_matched
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_that_was_previously_applied_is_matched
async def test_that_guideline_with_agent_intention_that_was_previously_applied_is_matched(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["provide_diagnosis"],
        relevant_guideline_names=["provide_diagnosis"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_that_was_previously_applied_but_should_not_reapply_is_not_matched
async def test_that_guideline_with_agent_intention_that_was_previously_applied_but_should_not_reapply_is_not_matched(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        conversation_guideline_names=["provide_diagnosis"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["provide_diagnosis"],
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_guideline_with_agent_intention_that_was_matched_but_action_wasnt_taken_is_not_matched_again
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_matched_based_on_capabilities_1
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_are_not_falsely_matched_based_on_capabilities
async def test_that_observational_guidelines_are_not_falsely_matched_based_on_capabilities(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        conversation_guideline_names=["unsupported_capability"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["unsupported_capability"],
        capabilities=capabilities,
    )


# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_a_guideline_that_has_several_steps_is_still_matched
...
# Taken from tests/core/stable/engines/alpha/test_guideline_matcher.py::test_that_condition_with_special_characters_causes_no_errors
async def test_that_condition_with_special_characters_causes_no_errors(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["special_character_condition"],
        relevant_guideline_names=["special_character_condition"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/unstable/engines/alpha/test_guideline_matcher.py::test_that_relevant_guidelines_are_matched_parametrized_1
async def test_that_relevant_guidelines_are_matched_parametrized_1(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (EventSource.CUSTOMER, "I'd like to order a pizza, please."),
        (EventSource.AI_AGENT, "No problem. What would you like to have?"),
        (EventSource.CUSTOMER, "I'd like a large pizza. What toppings do you have?"),
...
# Taken from tests/core/unstable/engines/alpha/test_guideline_matcher.py::test_that_guideline_that_needs_to_be_reapplied_is_matched
async def test_that_guideline_that_needs_to_be_reapplied_is_matched(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["large_pizza_crust"],
        relevant_guideline_names=["large_pizza_crust"],
        irrelevant_guideline_names=[],
    )


# Taken from tests/core/unstable/engines/alpha/test_guideline_matcher.py::test_that_guidelines_based_on_context_variables_arent_matched_repetitively
async def test_that_guidelines_based_on_context_variables_arent_matched_repetitively(
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        GUIDELINES_DICT,
        conversation=conversation,
        conversation_guideline_names=["summer_sale"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["summer_sale"],
        context_variables=[
            create_context_variable(
                name="season",
                data={"season": "Summer"},
...
# Taken from tests/core/unstable/engines/alpha/test_guideline_matcher.py::test_that_observational_guidelines_arent_wrongly_implied
async def test_that_observational_guidelines_arent_wrongly_implied(ranker: GuidelineRanker) -> None:
    conversation: list[tuple[EventSource, str]] = [
        (
            EventSource.CUSTOMER,
            "I didn't get any help from the previous representative. If this continues I'll switch to the competitors. Don't thread on me!",
    ...
    await base_test_that_guidelines_are_ranked_correctly(
        ...
        conversation_guideline_names=["season_is_winter"],
        relevant_guideline_names=[],
        irrelevant_guideline_names=["season_is_winter"],
        context_variables=[
            create_context_variable(
                name="Date",
